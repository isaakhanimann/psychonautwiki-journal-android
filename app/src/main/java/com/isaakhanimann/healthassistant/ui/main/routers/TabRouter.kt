...
sealed class TabRouter(val route: String, @StringRes val resourceId: Int, val icon: ImageVector) {
    object Experiences : TabRouter("experiences", R.string.experiences, Icons.Filled.PieChart)
    object Ingestions : TabRouter("ingestions", R.string.ingestions, Icons.Filled.Circle)
