            ...
            Text(
                buildAnnotatedString {
                    withStyle(style = paragraphStyle) {
                        append(bullet)
                        append("\t\t")
                        append("Familiar and uplifting music. An example of this includes our community good vibes portal. However, users are encouraged to create their own playlist that is composed of music one personally associates with being happy and relaxed.")
                    }
                    withStyle(style = paragraphStyle) {
                        append(bullet)
                        append("\t\t")
                        append("An extremely personal and ingrained image or object.")
                    }
                    withStyle(style = paragraphStyle) {
                        append(bullet)
                        append("\t\t")
                        append("Continuous repetition of a meaningful word or motto as a mantra.")
                    }
                    withStyle(style = paragraphStyle) {
                        append(bullet)
                        append("\t\t")
                        append("Writing an easily readable reminder onto a large piece of paper and placing it close within one's visual field throughout the experience. Common reminders include the name of the substance along with its dosage and phrases such as \"You are tripping on LSD.\" The same principle can be used to write reminders on one's hand or other visible body parts.")
                    }
                    withStyle(style = paragraphStyle) {
                        append(bullet)
                        append("\t\t")
                        append("An item of clothing or an accessory that is only worn during and therefore associated with the act of tripping.")
                    }
                }
            )
            Spacer(modifier = Modifier.height(5.dp))
