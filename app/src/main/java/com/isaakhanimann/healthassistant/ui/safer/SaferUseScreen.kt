...
fun SaferUseScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            CardWithTitle(title = "1. Research") {
            ...
            CardWithTitle(title = "4. Set and Setting") {
            ...
            CardWithTitle(title = "5. Combinations") {
            ...
            val uriHandler = LocalUriHandler.current
            CardWithTitle(title = "6. Administration Routes") {
            ...
            CardWithTitle(title = "7. Allergy Tests") {
            ...
            CardWithTitle(title = "8. Reflection") {
            ...
            CardWithTitle(title = "9. Safety of Others") {
            ...
            CardWithTitle(title = "10. Recovery Position") {
